...
<head>
  ...
  <!-- Favicon icon -->
  <link rel="icon" type="image/png" sizes="16x16" href="../../assets/back-end/images/favicon.png">
  <link rel="stylesheet" href="../../assets/back-end/vendor/chartist/css/chartist.min.css">
  <link href="../../assets/back-end/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
  <link href="../../assets/back-end/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
  <link href="../../assets/back-end/css/style.css" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&family=Roboto:wght@100;300;400;500;700;900&display=swap" rel="stylesheet">
  <!-- sweet alert -->
  <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  <!-- font awesome icon -->
  <script src="https://kit.fontawesome.com/03cd770933.js" crossorigin="anonymous"></script>
  <!-- data table -->
  ...
  <div id="main-wrapper">
    ...
    <div class="nav-header">
      <a href="#" class="brand-logo">
        <img class="logo-abbr" src="../../assets/back-end/images/logo.png" alt="">
        <img class="logo-compact" src="../../assets/back-end/images/logo-text.png" alt="">
        <img class="brand-title" src="../../assets/back-end/images/logo-text.png" alt="">
      </a>
            ...
            <ul class="navbar-nav header-right">
              ...
              <li class="nav-item dropdown header-profile">
                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                  <?php
                  if ($_SESSION['genarate_img'] == NULL) { ?>
                    <img src="../../src/back-end/images/users/default_img.jpg" width="20" alt="user img" />
                  <?php } else {  ?>
                    <img src="../../src/back-end/images/users/<?= $_SESSION['genarate_img']; ?>" width="20" alt="user img" />
                  <?php } ?>
                  <div class="header-info">
                    <span class="text-black"><strong><?php echo $_SESSION['genarate_name']; ?></strong></span>
                    <p class="fs-12 mb-0"><?php echo $_SESSION['genarate_type'] ?></p>
                  </div>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                  <a href="profile/profile.php" class="dropdown-item ai-icon">
                  ...
                  <a href="../../assets/back-end/email-inbox.html" class="dropdown-item ai-icon">
                  ...
                  <a href="signout.php" onclick="return confirm('Are you Sure??');" class="dropdown-item ai-icon">
        ...
        <ul class="metismenu" id="menu">
          ...
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
            ...
            <ul aria-expanded="false">
              ...
              <li><a href="user/view-users.php">View Users</a></li>
            </ul>
          </li>
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-381-television"></i>
            ...
            <ul aria-expanded="false">
              <li><a href="product/add-product.php">Add Product</a></li>
              <li><a href="product/view-products.php">View Products</a></li>
              <li><a href="product-meta/product-meta.php">Product Meta</a></li>
            </ul>
          </li>
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-381-television"></i>
            ...
            <ul aria-expanded="false">
              <li><a href="product-review/add-product_review.php">Add Product Review</a></li>
              <li><a href="product-review/view-product_reviews.php">View Product Reviews</a></li>
            </ul>
          </li>
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-381-television"></i>
            ...
            <ul aria-expanded="false">
              <li><a href="category/add-category.php">Add Category</a></li>
              <li><a href="category/view-categories.php">View Categories</a></li>
            </ul>
          </li>
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-381-television"></i>
            ...
            <ul aria-expanded="false">
              <li><a href="cart/add-cart.php">Add Cart</a></li>
              <li><a href="cart/view-carts.php">View Carts</a></li>
            </ul>
          </li>
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-381-television"></i>
              <span class="nav-text">Cart Item</span>
            </a>
            <ul aria-expanded="false">
              <li><a href="cart-item/add-cartItem.php">Add Cart Item</a></li>
              <li><a href="cart-item/view-cartItem.php">View Cart Item</a></li>
            </ul>
          </li>
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-381-television"></i>
            ...
            <ul aria-expanded="false">
              <li><a href="order/add-order.php">Add Order</a></li>
              <li><a href="order/view-orders.php">View Orders</a></li>
            </ul>
          </li>
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-381-television"></i>
            ...
            <ul aria-expanded="false">
              <li><a href="order-item/add-orderItem.php">Add OrderItem</a></li>
              <li><a href="order-item/view-orderItem.php">View Orders</a></li>
            </ul>
          </li>
          <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-381-television"></i>
            ...
            <ul aria-expanded="false">
              <li><a href="transaction/add-transaction.php">Add Transaction</a></li>
              <li><a href="transaction/view-transactions.php">View Transaction</a></li>
            </ul>
          </li>
        </ul>
      </div>
